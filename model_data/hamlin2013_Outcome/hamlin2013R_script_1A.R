...
# Helper
mean(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Successful Helper"])
sd(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Successful Helper"])

mean(D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Successful Helper"])
sd(D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Successful Helper"])
...
## POSTHOC MODELS ##
#Helper condition
t.test(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Successful Helper"],
       D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Successful Helper"],
