...
# Helper
mean(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Concordant Puppet"])
sd(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Concordant Puppet"])

mean(D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Concordant Puppet"])
sd(D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Concordant Puppet"])

# Hinderer
mean(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Slammer Puppet"])
sd(D_tall$measure[D_tall$unit_type=="Interaction Unit" & D_tall$char_type=="Slammer Puppet"])

mean(D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Slammer Puppet"])
sd(D_tall$measure[D_tall$unit_type=="NonInteraction Unit" & D_tall$char_type=="Slammer Puppet"])
# unit
